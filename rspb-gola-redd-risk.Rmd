...
aoi = aoi |>
  ...
  dplyr::filter(
    NAME   == "Gola Forest National Park" | 
      ...
      NAME == "Normon") |>
  sf::st_transform(4326)
country = sf::read_sf("~/repos/rspb-gola-review/data/aoi/liberia_boundary_national.shp")
...
knitr::include_graphics(c("~/repos/rspb-gola-review/data/site_maps/site_map.png",
                          "~/repos/rspb-gola-review/data/site_maps/locator_map.png"))
```
...
```{r, echo=F, message=F, warning=F, error=F, comment=NA}
samples = sf::st_read("~/repos/rspb-gola-review/data/training_samples/glance_spatial_clip.shp")
samples <- samples |>
...
# import
NDVI_2014=terra::rast("~/repos/rspb-gola-review/data/STACK/LANDSAT_TM-ETM-OLI_198055_NDVI_2014-01-04.tif")
NDVI_2019=terra::rast("~/repos/rspb-gola-review/data/STACK/LANDSAT_TM-ETM-OLI_198055_NDVI_2019-01-02.tif")
NDVI_2024=terra::rast("~/repos/rspb-gola-review/data/STACK/LANDSAT_TM-ETM-OLI_198055_NDVI_2024-01-16.tif")
STACK=raster::brick(
  "~/repos/rspb-gola-review/data/STACK/LANDSAT_TM-ETM-OLI_198055_STACK-&-DEM_2014-01-04_2024-01-16.tif")
...
***Accuracy assessments** (metrics differ slightly between runs)*
...
LULC_LIBERIA_2014 = raster::raster("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2014-01-04.tif")
LULC_LIBERIA_2019 = raster::raster("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2019-01-02.tif")
LULC_LIBERIA_2024 = raster::raster("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2024-01-16.tif")
...
LULC_LIBERIA_2014=terra::rast("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2014-01-04.tif")
LULC_LIBERIA_2019=terra::rast("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2019-01-02.tif")
LULC_LIBERIA_2024=terra::rast("~/repos/rspb-gola-review/data/LULC/LULC_LIBERIA_2024-01-16.tif")
...
raster::writeRaster(forest_2014, "~/repos/rspb-gola-review/data/LULC/forest_2014.tif",overwrite=T)
raster::writeRaster(forest_2019, "~/repos/rspb-gola-review/data/LULC/forest_2019.tif",overwrite=T)
raster::writeRaster(forest_2024, "~/repos/rspb-gola-review/data/LULC/forest_2024.tif",overwrite=T)
raster::writeRaster(forest_loss_2014_2019, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019.tif",overwrite=T)
raster::writeRaster(forest_loss_2019_2024, "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024.tif",overwrite=T)
raster::writeRaster(forest_loss_2014_2024, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024.tif",overwrite=T)
```

```{r, fig.show='hold', out.width="33%", echo=F}
forest_2014=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2014.tif")
forest_2019=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2019.tif")
forest_2024=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2024.tif")
forest_loss_2014_2019=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019.tif")
forest_loss_2019_2024=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024.tif")
forest_loss_2014_2024=terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024.tif")
...
raster::writeRaster(mask_gola_rast, "~/repos/rspb-gola-review/data/LULC/mask_gola.tif", overwrite=T)
raster::writeRaster(mask_tong_rast, "~/repos/rspb-gola-review/data/LULC/mask_tong.tif", overwrite=T)
raster::writeRaster(mask_norm_rast, "~/repos/rspb-gola-review/data/LULC/mask_norm.tif", overwrite=T)
raster::writeRaster(mask_project_rast, "~/repos/rspb-gola-review/data/LULC/mask_project.tif", overwrite=T)

mask_gola = terra::rast("~/repos/rspb-gola-review/data/LULC/mask_gola.tif")
mask_tong = terra::rast("~/repos/rspb-gola-review/data/LULC/mask_tong.tif")
mask_norm = terra::rast("~/repos/rspb-gola-review/data/LULC/mask_norm.tif")
mask_project = terra::rast("~/repos/rspb-gola-review/data/LULC/mask_project.tif")
...
raster::writeRaster(forest_2014_gola, "~/repos/rspb-gola-review/data/LULC/forest_2014_gola.tif", overwrite = T)
raster::writeRaster(forest_2014_tong, "~/repos/rspb-gola-review/data/LULC/forest_2014_tong.tif", overwrite = T)
raster::writeRaster(forest_2014_norm, "~/repos/rspb-gola-review/data/LULC/forest_2014_norm.tif", overwrite = T)
raster::writeRaster(forest_2014_project, "~/repos/rspb-gola-review/data/LULC/forest_2014_project.tif", overwrite = T)
...
raster::writeRaster(forest_2019_gola, "~/repos/rspb-gola-review/data/LULC/forest_2019_gola.tif", overwrite = T)
raster::writeRaster(forest_2019_tong, "~/repos/rspb-gola-review/data/LULC/forest_2019_tong.tif", overwrite = T)
raster::writeRaster(forest_2019_norm, "~/repos/rspb-gola-review/data/LULC/forest_2019_norm.tif", overwrite = T)
raster::writeRaster(forest_2019_project, "~/repos/rspb-gola-review/data/LULC/forest_2019_project.tif", overwrite = T)
...
raster::writeRaster(forest_2024_gola, "~/repos/rspb-gola-review/data/LULC/forest_2024_gola.tif", overwrite = T)
raster::writeRaster(forest_2024_tong, "~/repos/rspb-gola-review/data/LULC/forest_2024_tong.tif", overwrite = T)
raster::writeRaster(forest_2024_norm, "~/repos/rspb-gola-review/data/LULC/forest_2024_norm.tif", overwrite = T)
raster::writeRaster(forest_2024_project, "~/repos/rspb-gola-review/data/LULC/forest_2024_project.tif", overwrite = T)
...
raster::writeRaster(forest_loss_2014_2019_gola, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_gola.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2019_tong, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_tong.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2019_norm, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_norm.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2019_project, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_project.tif", overwrite = T)
...
raster::writeRaster(forest_loss_2019_2024_gola, "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_gola.tif", overwrite = T)
raster::writeRaster(forest_loss_2019_2024_tong, "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_tong.tif", overwrite = T)
raster::writeRaster(forest_loss_2019_2024_norm, "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_norm.tif", overwrite = T)
raster::writeRaster(forest_loss_2019_2024_project, "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_project.tif", overwrite = T)
...
raster::writeRaster(forest_loss_2014_2024_gola, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_gola.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2024_tong, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_tong.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2024_norm, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_norm.tif", overwrite = T)
raster::writeRaster(forest_loss_2014_2024_project, "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_project.tif", overwrite = T)
```

```{r, echo=F, cache=T, eval=F}
forest_2014_gola = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2014_gola.tif")
forest_2014_tong = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2014_tong.tif")
forest_2014_norm = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2014_norm.tif")
forest_2014_project = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2014_project.tif")

forest_2019_gola = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2019_gola.tif")
forest_2019_tong = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2019_tong.tif")
forest_2019_norm = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2019_norm.tif")
forest_2019_project = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2019_project.tif")

forest_2024_gola = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2024_gola.tif")
forest_2024_tong = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2024_tong.tif")
forest_2024_norm = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2024_norm.tif")
forest_2024_project = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_2024_project.tif")

forest_loss_2014_2019_gola = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_gola.tif")
forest_loss_2014_2019_tong = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_tong.tif")
forest_loss_2014_2019_norm = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_norm.tif")
forest_loss_2014_2019_project = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2019_project.tif")

forest_loss_2019_2024_gola = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_gola.tif")
forest_loss_2019_2024_tong = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_tong.tif")
forest_loss_2019_2024_norm = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_norm.tif")
forest_loss_2019_2024_project = terra::rast( "~/repos/rspb-gola-review/data/LULC/forest_loss_2019_2024_project.tif")

forest_loss_2014_2024_gola = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_gola.tif")
forest_loss_2014_2024_tong = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_tong.tif")
forest_loss_2014_2024_norm = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_norm.tif")
forest_loss_2014_2024_project = terra::rast("~/repos/rspb-gola-review/data/LULC/forest_loss_2014_2024_project.tif")
...
The following spatial covariates were imported as potential drivers of deforestation risk. We note further updates may be expected with additional sociodemographic data provided by client. We would also recommend that these assessments and mapping processes be updated or replaced prior to completion of PD, especially following the expected release of Liberia's Activity Data and jurisdictional deforestation risk maps from Verra.

```{r, eval=F, cache=T}
# Download sociodemographic data
pop_url <- "https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/GHS_POP_GLOBE_R2023A/GHS_POP_E2025_GLOBE_R2023A_54009_1000/V1-0/GHS_POP_E2025_GLOBE_R2023A_54009_1000_V1_0.zip" # global population density raster (person/km^2)
osm_url <- "https://download.geofabrik.de/africa/liberia-latest-free.shp.zip" # OSM shapefiles

# Import data
population   = terra::rast("./data/pop/liberia_population.tif")
buildings    = terra::vect("./data/liberia-osmdata/gis_osm_buildings_a_free_1.shp")
waterbody    = terra::vect("./data/liberia-osmdata/gis_osm_water_a_free_1.shp")
waterways    = terra::vect("./data/liberia-osmdata/gis_osm_waterways_free_1.shp")
transport    = terra::vect("./data/liberia-osmdata/gis_osm_transport_a_free_1.shp")
railways     = terra::vect("./data/liberia-osmdata/gis_osm_railways_free_1.shp")
worship      = terra::vect("./data/liberia-osmdata/gis_osm_pofw_free_1.shp")
places       = terra::vect("./data/liberia-osmdata/gis_osm_places_a_free_1.shp")
roads        = terra::vect("./data/liberia-osmdata/gis_osm_roads_free_1.shp")
public_space = terra::vect("./data/liberia-osmdata/gis_osm_pois_a_free_1.shp")

places_local = terra::vect("./data/liberia-osmdata/liberia_point.shp")
places_lines = terra::vect("./data/liberia-osmdata/liberia_poly.shp")

plot(places_local)
plot(places_lines)

waterways_project = sf::st_read("./data/Winrock_GIS Analysis Gola/PA_river.shp")
places_project    = sf::st_read("./data/Winrock_GIS Analysis Gola/Communities_8km.shp")
roads_project     = sf::st_read("./data/Winrock_GIS Analysis Gola/PA_roads.shp")
slope_percent     = terra::rast("./data/DEM/slope_percent.tif")
forest_loss       = forest_loss_2014_2024  

# Tidy data
population    = terra::crop(population, country)
public_space  = terra::crop(public_space, country) |> sf::st_as_sf()
buildings     = terra::crop(buildings, country) |> sf::st_as_sf()
waterbody     = terra::crop(waterbody, country) |> sf::st_as_sf()
waterways     = terra::crop(waterways, country) |> sf::st_as_sf()
transport     = terra::crop(transport, country) |> sf::st_as_sf()
railways      = terra::crop(railways, country) |> sf::st_as_sf()
worship       = terra::crop(worship, country) |> sf::st_as_sf()
places        = terra::crop(places, country) |> sf::st_as_sf()
roads         = terra::crop(roads, country) |> sf::st_as_sf()

# visualize
population = raster::raster(population)
names(population)[1] <- "density"
tmap::tm_shape(country) +
  ...
  tmap::tm_credits("EPSG:4326", position = c("left", "bottom")) +
  tmap::tm_scale_bar(position=c("RIGHT", "BOTTOM"), text.size = .5) + 
  tmap::tm_compass(color.dark="gray60",text.color="gray60",position=c("RIGHT", "top")) -> tm1

tmap::tm_shape(country) + tmap::tm_borders(lwd = 1.5, col = "blue") +
  tmap::tm_shape(aoi) + tmap::tm_borders(lwd = 1, col = "red") +
  tmap::tm_text("NAME", just = "center", col="white", size=1.1) +
  tmap::tm_shape(waterbody) + tmap::tm_fill(col = "lightblue") +
  tmap::tm_shape(waterways) + tmap::tm_lines(col = "lightblue", lwd=0.9, legend.show = TRUE) +
  tmap::tm_shape(waterways_project) + tmap::tm_lines(col = "lightblue", lwd=0.9) +
  tmap::tm_shape(roads) + tmap::tm_lines(col = "yellow", lwd=0.7, legend.show = TRUE) +
  tmap::tm_shape(roads_project) + tmap::tm_lines(col = "yellow", lwd=0.7) +
  tmap::tm_shape(railways) + tmap::tm_lines(col = "orange", lwd=1, lty = "dashed",legend.show = TRUE) +
  tmap::tm_shape(transport) + tmap::tm_borders(col = "green", lwd=0.8) +
  tmap::tm_shape(places) + tmap::tm_borders(col="white") + 
  tmap::tm_text("name",just="left", col="white", size=0.6) +
  tmap::tm_shape(places_project) + tmap::tm_dots(col="white", group="fclass") +
  tmap::tm_text("name",just="left", col="white", size=0.6) +
  tmap::tm_shape(public_space) + tmap::tm_borders(col="pink") +
  tmap::tm_shape(buildings) + tmap::tm_borders(col="brown", legend.show = TRUE) +
  tmap::tm_shape(worship) + tmap::tm_dots(col="purple", legend.show = TRUE) +
  tmap::tm_basemap("Esri.WorldImagery") -> tm2

#tmap::tmap_save(tm1, "./data/site_maps/population_map.png", height=10000, asp=0, dpi=1200)
#tmap::tmap_save(tm2, "./data/site_maps/defor_drivers_map.png", height=10000, asp=0, dpi=2400)
...
```{r}
roads_raster <- rasterize(roads, forest_loss, fun = "distance")
