...
distance_to_forest_inv <- 1 - distance_to_forest
distance_to_roads_inv  <- 1 - distance_to_roads
distance_to_places_inv <- 1 - distance_to_places
distance_to_waterways_inv <- 1 -  distance_to_waterways
distance_to_urban_inv   <- 1 - distance_to_urban
population_inv <- 1 - population
slope_inv <- 1 - slope

writeRaster(distance_to_forest_inv, "./data/BINARY/distance_to_forest_inv.tif", overwrite=T)
writeRaster(distance_to_roads_inv, "./data/BINARY/distance_to_roads_inv.tif", overwrite=T)
writeRaster(distance_to_places_inv, "./data/BINARY/distance_to_places_inv.tif", overwrite=T)
writeRaster(distance_to_waterways_inv, "./data/BINARY/distance_to_waterways_inv.tif", overwrite=T)
writeRaster(distance_to_urban_inv, "./data/BINARY/distance_to_urban_inv.tif", overwrite=T)
writeRaster(population_inv, "./data/BINARY/population_inv.tif", overwrite=T)
