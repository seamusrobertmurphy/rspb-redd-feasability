...
The following spatial covariates were imported as potential drivers of deforestation risk, which included combination of in-depth data sources sourced and vetted by the Winrock GIS team, along with national level sociodemographic datasets employed to provide regional comparisons across jurisdictions. To support the upcoming collaboration with RSPB contractors and ensure replicability in all Winrock workflows, the team has shared below additional links to the main data warehouses consulted in the following operations.

We note further updates may be expected with additional sociodemographic data provided by client. We would also recommend that these assessments and mapping processes be updated or replaced prior to completion of PD, especially following the expected release of Liberia's Activity Data and jurisdictional deforestation risk maps from Verra.
...
waterpoly     = sf::st_read("./data/liberia-osmdata/waterpoly_valid.shp") 
